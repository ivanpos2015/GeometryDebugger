...
HRESULT SceneGraphEditor::Initialize(__in ISceneGraph *pSceneGraph)
{
	if (!pSceneGraph)
		return E_INVALIDARG;
...
HRESULT SceneGraphEditor::ClearSceneGraph()
{
	...
	return Initialize(m_spSceneGraph);
}
...
HRESULT CreateSceneGraphEditor(__in ISceneGraph *pSceneGraph, __deref_out ISceneGraphEditor **ppSceneGraphEditor)
{
    ...
    return SceneGraphEditor::CreateInstance(ppSceneGraphEditor, pSceneGraph);
};