...
class BackgroundToolSource : 
    public ImplementSmartObject<BackgroundToolSource, InheritImplementation<ContinuousToolSource> >
{
public:
    // zero level priority (background tool group) handler
    HRESULT GetToolSourcePriority(UserInputEvent &evnt, __out UINT *pPriority);
};
